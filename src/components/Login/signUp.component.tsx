...
const SignUp: FunctionComponent = () => {
  ...
  const handleSubmit = () => {
    if (validate()) {
      ProjectService.createUser(formValues).then(() => {
        UtilityService.ShowNotification(toast, NotificationTypeEnum.Success, 'user created successfully');
        setTimeout(() => {
          navigate("/");
        ...
        UtilityService.ShowNotification(toast, NotificationTypeEnum.Error, error || 'something Went wrong');
  ...
  return (
    <div className="flex justify-content-around" style={{
      ...
      >
            ...
            <div className="flex justify-content-between mt-4 flex-wrap">
              ...
              <div className="w-18rem">
                ...
                {formErrors.companyWebsite && (
                  <small className="p-error">{formErrors.companyWebsite}</small>
                )}
              </div>
            </div>
            <div className="flex justify-content-between mt-4  flex-wrap">
              <div>
                ...
                {formErrors.companyAddress && (
                  <small className="p-error">{formErrors.companyAddress}</small>
                )}
              </div>
            </div>
          </div>
        ...
        <div className="mt-4">
          <span className="text-500">
            ...
            <a onClick={openLoginPage} className="cursor-pointer text-primary underline">
              &nbsp; Login
            </a>
          </span>
        </div>
